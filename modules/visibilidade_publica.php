...
?>
<section class="mb-4"><span class="mt-eyebrow">Diretório comunitário</span><h1 class="mt-page-title">Perfil público da casa</h1><p class="mt-subtitle">Casas aprovadas aparecem no diretório por padrão. A própria casa pode remover o perfil público a qualquer momento e escolhe quais detalhes, contatos e localização deseja compartilhar.</p></section>
