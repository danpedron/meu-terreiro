...
$results = $service->findPublicTenants($hasCoordinates ? (float) $lat : null, $hasCoordinates ? (float) $lng : null, $city ?: null, $radius);
$markers = [];
...
<head>
    ...
    <title>Encontrar uma casa — Meu Terreiro</title>
...
<nav class="navbar navbar-expand-lg mt-navbar navbar-dark">
    <div class="container"><a class="navbar-brand mt-brand" href="index.php"><span class="mt-brand-mark"><i class="fa-solid fa-leaf"></i></span>Meu Terreiro</a><div class="ms-auto d-flex gap-2"><a class="btn btn-sm btn-outline-light" href="index.php?p=comunidade">Minha comunidade</a><a class="btn btn-sm btn-light" href="index.php?p=login">Entrar</a></div></div>
</nav>
