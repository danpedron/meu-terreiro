...
$filhosAtivos = (int) ($tenant['filhos_ativos'] ?? 0);
...
<section class="mt-profile-hero rounded-4 p-4 p-lg-5 mb-4"><span class="mt-eyebrow">Casa no diretório comunitário</span><h1 class="display-5 fw-bold mb-2"><?php echo e($tenant['nome_exibicao']); ?></h1><?php if ($tenant['nacao_publica']): ?><p class="lead mb-2"><i class="fa-solid fa-seedling me-2"></i><?php echo e($tenant['nacao_publica']); ?></p><?php endif; ?><p class="mb-3"><?php echo e($tenant['bairro_publico'] ?: ($tenant['cidade_publica'] ?: 'A localização detalhada é compartilhada diretamente pela casa.')); ?><?php echo $tenant['estado_publico'] ? ', ' . e($tenant['estado_publico']) : ''; ?></p><span class="badge rounded-pill text-bg-success"><i class="fa-solid fa-users me-1"></i><?php echo number_format($filhosAtivos, 0, ',', '.'); ?> filho<?php echo $filhosAtivos === 1 ? '' : 's'; ?> ativo<?php echo $filhosAtivos === 1 ? '' : 's'; ?></span></section>
